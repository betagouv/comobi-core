...
export default () => html`
	<${Container}>
		...
		<label>De quelle commune partez-vous ? <input /></label>
		<label
		...
		<label
			>Si vous faites ce trajet de manière régulière, quels jours de la semaine
			le faites-vous ? <${DaysInput}><//
		></label>
		<label>
		...
		<label
			...
			<label
				...
				(partage des frais à définir avec le passager, ou alternance de véhicule
				etc.)</label
			>
			<label
		...
		<${Button('#9fba93')}>Proposer ce trajet<//>
	<//>
`
